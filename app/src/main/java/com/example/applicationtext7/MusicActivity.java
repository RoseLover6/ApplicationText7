package com.example.applicationtext7;
...
public class MusicActivity extends Activity{
    ...
    private void download() {
        try {
            ...
            File file = new File("data/data/com.example.applicationtext7/test.mp3");
            if (!file.exists()){
                file.createNewFile();
            }
    ...
    private void display() {
        ...
        mediaPlayer = MediaPlayer.create(this,Uri.parse("data/data/com.example.applicationtext7/test.mp3"));
        mediaPlayer.start();
